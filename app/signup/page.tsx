  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        {/* Background Image */}
        <Image
          src="/e87c2d5ca63b2ae1e71893b14f954e846467c97c.jpg"
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md space-y-8">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="confirm-password" className="block text-sm font-medium text-gray-700 mb-2 uppercase tracking-wide">
                Confirm Password
              </label>
              <input
                id="confirm-password"
            ...
            >
              {loading ? 'Creating account...' : 'Enter the Sanctuary'}
              {!loading && <span>→</span>}
            </button>
          </form>
